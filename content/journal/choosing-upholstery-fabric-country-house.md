...
summary: "A maker's guide to choosing upholstery fabric that balances beauty
  with durability: from the Martindale rub test to the fabrics we reach for
  most often."
pillar: fabric
tags:
  - Fabrics
...
We always begin here with our clients. It sounds obvious, but the most common mistake we see is choosing fabric with the eyes alone. The second question, how it will wear, is the one that saves heartache later.
...
A number alone doesn't tell the whole story, since weave structure, fibre content, and finish all play a role, but it's a sensible starting point. We always check the Martindale rating before recommending a fabric for upholstery, and we'd encourage you to do the same.
...
The key is choosing performance fabrics from reputable houses where the hand and drape have been carefully considered, not the stiff, plastic-feeling textiles of a decade ago. We stock several in our [Broadway showroom](/showroom/broadway), and we always invite clients to feel the difference for themselves.
...
Once you've established the practical requirements of rub count, fibre type, and performance needs, you can begin thinking about colour and pattern. Here, context is everything.
...
If you're starting from scratch and want a single, reliable approach: choose a heavy linen-cotton blend in a neutral tone for your main seating, add depth with a wool or velvet on an accent chair, and bring personality through cushions and throws where the commitment is lower and the fabric can be more adventurous. The plains, checks and tickings in [our upholstery fabric range](/fabrics) are chosen with exactly this approach in mind.

If you'd like to discuss fabric options for a specific project, our showroom at the [Cotswold Design Centre in Broadway](/showroom/broadway) has an extensive library of samples from the fabric houses we work with. You're welcome to visit: seeing and touching the fabric is always better than choosing from a screen.
