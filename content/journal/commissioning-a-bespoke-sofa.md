...
With the shape and scale agreed, we move to fabric. This is where the showroom earns its place: clients come in, sit with us, and work through the options with the actual material in their hands. A swatch in a book gives you colour and pattern. A full metre draped over a frame gives you drape, weight, and the way light moves across the surface. There's no substitute for seeing fabric at scale. Many clients start with [our upholstery fabric range](/fabrics), plains in fourteen colours with checks, stripes and tickings woven to match, before narrowing the choice in the showroom.
...
The final details of piping, trim, feet and castors are fitted last. We keep a range of finishes in the workshop, from turned oak legs to brass cup castors, and we're always happy to source something specific if the scheme demands it.
